package com.zenchn.picbrowserlib.pojo;
 ...
 * 描    述：管理图片资源DO
 * 修订记录： release包注意将此类排除混淆
 * @author HZJ
 */
public class ImageSourceInfo implements Parcelable, Serializable {

    private static final long serialVersionUID = -607981487471678230L;
    /***图片oss id***/
    public String ossId;
    ...
    public static ImageSourceInfo getImageSourceInfo(Object source) {
        if (source instanceof Integer) {
            ...
            boolean isOnline = URIUtil.isOnlinePicture((String) source);
